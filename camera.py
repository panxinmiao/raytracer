...
class OrbitCamera:
    ...
    # def on_before_render(self, update_buffer_func=None):
    #     if self._need_calculate_buffer:
    #         self.calculate_buffer_data()

    #     if update_buffer_func is not None:
    #         if self._need_update_buffer:
    #             update_buffer_func(self.buffer_data)
