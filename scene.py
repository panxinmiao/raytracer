...
class Triangle(np.ndarray):
    ...
    def __init__(self, v0=(0, 0, 0), v1=(0, 0, 0), v2=(0, 0, 0), n0=(0, 0, 0), n1=(0, 0, 0), n2=(0, 0, 0), material_index=0):
        super().__init__()
        self["p0"] = v0
        self["p1"] = v1
        self["p2"] = v2
...
class Scene:
    ...
    def get_buffer_datas(self):
        triangles_b = np.concatenate(self.triangles)
        materials_b = np.concatenate(self.materials)
    ...
    def parse_gfx_scene(s: gfx.Scene):
        ...
        def parse_node(node):
            if isinstance(node, gfx.Mesh):
                ...
                vertices = np.hstack((vertices, np.ones((vertices.shape[0], 1), dtype=vertices.dtype)))
